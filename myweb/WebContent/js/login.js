...
function valtcode() {
    var tcity = document.getElementById("vcode");
    var tspan = document.getElementById("vcodeerr");
    var x = "";
...
function valtpassword() {
    var tcity = document.getElementById("password");
    var tspan = document.getElementById("password1-err");
    var x = "";
